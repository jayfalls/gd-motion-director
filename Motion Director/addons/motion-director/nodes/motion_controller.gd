@tool
class_name MotionDirectorController extends Node


# VARIABLES
## Identifier
const is_motion: Object = null
...
@export var unique_motions: Dictionary # All the unique motions and their names
@export var event_motions: Dictionary # All the events and their motions
...
func _get_configuration_warnings() -> PackedStringArray:
	...
	if get_parent() != edited_scene_root:
		warnings.append("MotionDirectorController needs to be child of root node")
	return warnings
